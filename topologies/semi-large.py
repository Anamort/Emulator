...
class CustomTopology( Topo ):
  def __init__( self ):
    ...
    router32 = self.addHost('router32', ips=['192.168.1.42/24','10.10.31.2/24','10.10.64.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router35 = self.addHost('router35', ips=['192.168.1.45/24','10.10.34.2/24','10.10.68.1/24'],
          controller_ip="192.168.1.10",
          cls=RAUSwitch)
    

    router36 = self.addHost('router36', ips=['192.168.1.46/24','10.10.35.2/24','10.10.70.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)
    ...
    router43 = self.addHost('router43', ips=['192.168.1.53/24','10.10.42.2/24','10.10.78.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router45 = self.addHost('router45', ips=['192.168.1.55/24','10.10.44.2/24','10.10.80.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router50 = self.addHost('router50', ips=['192.168.1.60/24','10.10.49.2/24','10.10.85.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router52 = self.addHost('router52', ips=['192.168.1.62/24','10.10.51.2/24','10.10.88.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router55 = self.addHost('router55', ips=['192.168.1.65/24','10.10.54.2/24','10.10.91.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router56 = self.addHost('router56', ips=['192.168.1.66/24','10.10.55.2/24','10.10.93.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router58 = self.addHost('router58', ips=['192.168.1.68/24','10.10.57.2/24','10.10.96.1/24'],
          controller_ip="192.168.1.10",
          cls=RAUSwitch)
    ...
    router60 = self.addHost('router60', ips=['192.168.1.70/24','10.10.59.2/24','10.10.98.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router61 = self.addHost('router61', ips=['192.168.1.71/24','10.10.60.2/24','10.10.100.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router62 = self.addHost('router62', ips=['192.168.1.72/24','10.10.61.2/24','10.10.102.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router63 = self.addHost('router63', ips=['192.168.1.73/24','10.10.62.2/24','10.10.104.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router101 = self.addHost('router101', ips=['192.168.1.111/24','10.10.100.2/24','10.1.0.2/24'],
        controller_ip="192.168.1.10",
    ...
    self.addLink(router45, router81, 2, 1)
