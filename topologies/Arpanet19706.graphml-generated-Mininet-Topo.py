...
class CustomTopology( Topo ):
    ...
    def __init__( self, **opts ):
        ...
        MIT = self.addHost('switch8', loopback='127.0.0.1', controller_ip='192.168.1.10', cls=RAUSwitch, ips=['192.168.1.17/24','10.10.9.2/24','10.10.10.1/24'])
        ...
        BBN = self.addHost('switch9', loopback='127.0.0.1', controller_ip='192.168.1.10', cls=RAUSwitch, ips=['192.168.1.19/24','10.10.1.2/24','10.10.6.2/24','10.10.10.2/24'])
