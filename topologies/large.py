...
class CustomTopology( Topo ):
  def __init__( self ):
    ...
    router4 = self.addHost('router4', loopback="127.0.0.1",
		  ips=['192.168.1.14/24','10.10.2.2/24','10.10.3.2/24','10.10.4.1/24'],
		  controller_ip="192.168.1.10",
		  cls=RAUSwitch)

    router5 = self.addHost('router5', loopback="127.0.0.1",
        ips=['192.168.1.15/24','10.10.4.2/24','10.10.5.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router6 = self.addHost('router6', loopback="127.0.0.1",
        ips=['192.168.1.16/24','10.10.5.2/24','10.10.7.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router9 = self.addHost('router9', loopback="127.0.0.1",
        ips=['192.168.1.19/24','10.10.10.2/24','10.10.11.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router10 = self.addHost('router10', loopback="127.0.0.1",
        ips=['192.168.1.20/24','10.10.11.2/24','10.10.12.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router11 = self.addHost('router11', loopback="127.0.0.1",
        ips=['192.168.1.21/24','10.10.12.2/24','10.10.13.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router12 = self.addHost('router12', loopback="127.0.0.1",
              ips=['192.168.1.22/24','10.10.14.2/24','10.10.13.2/24','10.10.19.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router13 = self.addHost('router13', loopback="127.0.0.1",
          ips=['192.168.1.23/24','10.10.19.2/24','10.0.0.2/24','10.0.0.2/24'],
          controller_ip="192.168.1.10",
          cls=RAUSwitch)
    

    router14 = self.addHost('router14', loopback="127.0.0.1",
              ips=['192.168.1.24/24','10.10.20.2/24','10.0.0.2/24','10.0.0.2/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)
    

    router15 = self.addHost('router15', loopback="127.0.0.1",
              ips=['192.168.1.25/24','10.10.18.2/24','10.10.17.1/24','10.0.0.2/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router16 = self.addHost('router16', loopback="127.0.0.1",
        ips=['192.168.1.26/24','10.10.9.2/24','10.10.17.2/24','10.10.15.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router17 = self.addHost('router17', loopback="127.0.0.1",
        ips=['192.168.1.27/24','10.10.15.2/24','10.0.0.2/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router18 = self.addHost('router18', loopback="127.0.0.1",
        ips=['192.168.1.28/24','10.10.16.2/24','10.10.22.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router19 = self.addHost('router19', loopback="127.0.0.1",
        ips=['192.168.1.29/24','10.10.21.2/24','10.10.23.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router20 = self.addHost('router20', loopback="127.0.0.1",
        ips=['192.168.1.30/24','10.10.22.2/24','10.10.24.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router21 = self.addHost('router21', loopback="127.0.0.1",
        ips=['192.168.1.31/24','10.10.23.2/24','10.10.24.2/24','10.10.29.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router23 = self.addHost('router23', loopback="127.0.0.1",
              ips=['192.168.1.33/24','10.10.26.2/24','10.10.27.1/24','10.0.0.2/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router24 = self.addHost('router24', loopback="127.0.0.1",
          ips=['192.168.1.34/24','10.10.27.2/24','10.10.28.1/24','10.0.0.2/24'],
          controller_ip="192.168.1.10",
          cls=RAUSwitch)
    

    router25 = self.addHost('router25', loopback="127.0.0.1",
              ips=['192.168.1.35/24','10.10.31.2/24','10.10.32.1/24','10.0.0.2/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)
    

    router26 = self.addHost('router26', loopback="127.0.0.1",
              ips=['192.168.1.36/24','10.10.32.2/24','10.10.33.1/24','10.0.0.2/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router27 = self.addHost('router27', loopback="127.0.0.1",
        ips=['192.168.1.37/24','10.10.30.2/24','10.10.33.2/24','10.10.34.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router28 = self.addHost('router28', loopback="127.0.0.1",
        ips=['192.168.1.38/24','10.10.34.2/24','10.10.36.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router30 = self.addHost('router30', loopback="127.0.0.1",
        ips=['192.168.1.40/24','10.10.35.2/24','10.10.39.1/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    self.addLink(router59, router98, 2, 1)
    self.addLink(router59, router99, 3, 1)
    self.addLink(router60, router100, 2, 1)
    self.addLink(router60, router101, 3, 1)
    self.addLink(router61, router102, 2, 1)
    self.addLink(router61, router103, 3, 1)
    self.addLink(router62, router104, 2, 1)
    self.addLink(router62, router105, 3, 1)
