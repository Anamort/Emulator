...
class CustomTopology( Topo ):
  def __init__( self ):
    ...
    router34 = self.addHost('router34', ips=['192.168.1.44/24','10.10.40.2/24','10.10.42.2/24','10.10.43.1/24','10.10.45.1/24','10.10.44.1/24','10.1.0.2/24'],
              controller_ip="192.168.1.10",
    ...
    router37 = self.addHost('router37', ips=['192.168.1.47/24','10.10.47.2/24','10.10.48.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router38 = self.addHost('router38', ips=['192.168.1.48/24','10.10.48.2/24','10.0.0.2/24'],
        controller_ip="192.168.1.10",
    ...
    ## Enlaces CE
    self.addLink(router38, routerLan1, 2, 0)
    self.addLink(router34, routerLan2, 6, 0)
