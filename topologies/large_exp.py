...
class CustomTopology( Topo ):
  def __init__( self ):
    ...
    router2 = self.addHost('router2', loopback="127.0.0.1",
	      ips=['192.168.1.12/24','10.10.1.2/24','10.10.3.1/24','10.10.4.1/24'],
	      controller_ip="192.168.1.10",
	      cls=RAUSwitch)
    

    router3 = self.addHost('router3', loopback="127.0.0.1",
		  ips=['192.168.1.13/24','10.10.2.2/24','10.10.5.1/24','10.10.6.1/24'],
		  controller_ip="192.168.1.10",
		  cls=RAUSwitch)
    

    router4 = self.addHost('router4', loopback="127.0.0.1",
		  ips=['192.168.1.14/24','10.10.3.2/24','10.10.7.1/24','10.10.8.1/24'],
		  controller_ip="192.168.1.10",
		  cls=RAUSwitch)

    router5 = self.addHost('router5', loopback="127.0.0.1",
        ips=['192.168.1.15/24','10.10.4.2/24','10.10.9.1/24','10.10.10.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router6 = self.addHost('router6', loopback="127.0.0.1",
        ips=['192.168.1.16/24','10.10.5.2/24','10.10.11.1/24','10.10.12.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router7 = self.addHost('router7', loopback="127.0.0.1",
        ips=['192.168.1.17/24','10.10.6.2/24','10.10.13.1/24','10.10.14.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router8 = self.addHost('router8', loopback="127.0.0.1",
        ips=['192.168.1.18/24','10.10.7.2/24','10.10.15.1/24','10.10.16.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router9 = self.addHost('router9', loopback="127.0.0.1",
        ips=['192.168.1.19/24','10.10.8.2/24','10.10.17.1/24','10.10.18.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router10 = self.addHost('router10', loopback="127.0.0.1",
        ips=['192.168.1.20/24','10.10.9.2/24','10.10.19.1/24','10.10.20.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router11 = self.addHost('router11', loopback="127.0.0.1",
        ips=['192.168.1.21/24','10.10.10.2/24','10.10.21.1/24','10.10.22.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router12 = self.addHost('router12', loopback="127.0.0.1",
              ips=['192.168.1.22/24','10.10.11.2/24','10.10.23.1/24','10.10.24.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router13 = self.addHost('router13', loopback="127.0.0.1",
          ips=['192.168.1.23/24','10.10.12.2/24','10.10.25.1/24','10.10.26.1/24'],
          controller_ip="192.168.1.10",
          cls=RAUSwitch)
    

    router14 = self.addHost('router14', loopback="127.0.0.1",
              ips=['192.168.1.24/24','10.10.13.2/24','10.10.27.1/24','10.10.28.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)
    

    router15 = self.addHost('router15', loopback="127.0.0.1",
              ips=['192.168.1.25/24','10.10.14.2/24','10.10.29.1/24','10.10.30.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router16 = self.addHost('router16', loopback="127.0.0.1",
        ips=['192.168.1.26/24','10.10.15.2/24','10.10.31.1/24','10.10.32.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router17 = self.addHost('router17', loopback="127.0.0.1",
        ips=['192.168.1.27/24','10.10.16.2/24','10.10.33.1/24','10.10.34.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router18 = self.addHost('router18', loopback="127.0.0.1",
        ips=['192.168.1.28/24','10.10.17.2/24','10.10.35.1/24','10.10.36.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router19 = self.addHost('router19', loopback="127.0.0.1",
        ips=['192.168.1.29/24','10.10.18.2/24','10.10.37.1/24','10.10.38.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router20 = self.addHost('router20', loopback="127.0.0.1",
        ips=['192.168.1.30/24','10.10.19.2/24','10.10.39.1/24','10.10.40.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router21 = self.addHost('router21', loopback="127.0.0.1",
        ips=['192.168.1.31/24','10.10.20.2/24','10.10.41.1/24','10.10.42.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router22 = self.addHost('router22', loopback="127.0.0.1",
        ips=['192.168.1.32/24','10.10.21.2/24','10.10.43.1/24','10.10.44.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router23 = self.addHost('router23', loopback="127.0.0.1",
              ips=['192.168.1.33/24','10.10.22.2/24','10.10.45.1/24','10.10.46.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router24 = self.addHost('router24', loopback="127.0.0.1",
          ips=['192.168.1.34/24','10.10.23.2/24','10.10.47.1/24','10.10.48.1/24'],
          controller_ip="192.168.1.10",
          cls=RAUSwitch)
    

    router25 = self.addHost('router25', loopback="127.0.0.1",
              ips=['192.168.1.35/24','10.10.24.2/24','10.10.49.1/24','10.10.50.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)
    

    router26 = self.addHost('router26', loopback="127.0.0.1",
              ips=['192.168.1.36/24','10.10.25.2/24','10.10.51.1/24','10.10.52.1/24'],
              controller_ip="192.168.1.10",
              cls=RAUSwitch)

    router27 = self.addHost('router27', loopback="127.0.0.1",
        ips=['192.168.1.37/24','10.10.26.2/24','10.10.53.1/24','10.10.54.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router28 = self.addHost('router28', loopback="127.0.0.1",
        ips=['192.168.1.38/24','10.10.27.2/24','10.10.55.1/24','10.10.56.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router29 = self.addHost('router29', loopback="127.0.0.1",
        ips=['192.168.1.39/24','10.10.28.2/24','10.10.57.1/24','10.10.58.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router30 = self.addHost('router30', loopback="127.0.0.1",
        ips=['192.168.1.40/24','10.10.29.2/24','10.10.59.1/24','10.10.60.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router31 = self.addHost('router31', loopback="127.0.0.1",
        ips=['192.168.1.41/24','10.10.30.2/24','10.10.61.1/24','10.10.62.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router32 = self.addHost('router32', loopback="127.0.0.1",
        ips=['192.168.1.42/24','10.10.31.2/24','10.10.63.1/24','10.10.64.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    ...
    router35 = self.addHost('router35', loopback="127.0.0.1",
          ips=['192.168.1.45/24','10.10.34.2/24','10.10.67.1/24','10.10.68.1/24'],
          controller_ip="192.168.1.10",
          cls=RAUSwitch)
    

    router36 = self.addHost('router36', loopback="127.0.0.1",
              ips=['192.168.2.11/24','10.10.35.2/24','10.10.69.1/24','10.10.70.1/24'],
              controller_ip="192.168.2.10",
              cls=RAUSwitch)
    

    router37 = self.addHost('router37', loopback="127.0.0.1",
              ips=['192.168.2.12/24','10.10.36.2/24','10.10.71.1/24'],
              controller_ip="192.168.2.10",
              cls=RAUSwitch)

    router38 = self.addHost('router38', loopback="127.0.0.1",
        ips=['192.168.2.13/24','10.10.37.2/24','10.10.72.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router39 = self.addHost('router39', loopback="127.0.0.1",
        ips=['192.168.2.14/24','10.10.38.2/24','10.10.73.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)
    

    router40 = self.addHost('router40', loopback="127.0.0.1",
        ips=['192.168.2.15/24','10.10.39.2/24','10.10.74.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)
    

    router41 = self.addHost('router41', loopback="127.0.0.1",
        ips=['192.168.2.16/24','10.10.40.2/24','10.10.75.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router42 = self.addHost('router42', loopback="127.0.0.1",
        ips=['192.168.2.17/24','10.10.41.2/24','10.10.76.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router43 = self.addHost('router43', loopback="127.0.0.1",
        ips=['192.168.2.18/24','10.10.42.2/24','10.10.77.1/24','10.10.78.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)
    

    router44 = self.addHost('router44', loopback="127.0.0.1",
        ips=['192.168.2.19/24','10.10.43.2/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router45 = self.addHost('router45', loopback="127.0.0.1",
        ips=['192.168.2.20/24','10.10.44.2/24','10.10.79.1/24','10.10.80.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router46 = self.addHost('router46', loopback="127.0.0.1",
          ips=['192.168.2.21/24','10.10.45.2/24','10.10.81.1/24'],
          controller_ip="192.168.2.10",
          cls=RAUSwitch)

    router47 = self.addHost('router47', loopback="127.0.0.1",
          ips=['192.168.2.22/24','10.10.46.2/24','10.10.82.1/24'],
          controller_ip="192.168.2.10",
          cls=RAUSwitch)
    

    router48 = self.addHost('router48', loopback="127.0.0.1",
          ips=['192.168.2.23/24','10.10.47.2/24','10.10.83.1/24'],
          controller_ip="192.168.2.10",
          cls=RAUSwitch)
    

    router49 = self.addHost('router49', loopback="127.0.0.1",
          ips=['192.168.2.24/24','10.10.48.2/24'],
          controller_ip="192.168.2.10",
          cls=RAUSwitch)

    router50 = self.addHost('router50', loopback="127.0.0.1",
        ips=['192.168.2.25/24','10.10.49.2/24','10.10.84.1/24','10.10.85.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router51 = self.addHost('router51', loopback="127.0.0.1",
        ips=['192.168.2.26/24','10.10.50.2/24','10.10.86.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)
    

    router52 = self.addHost('router52', loopback="127.0.0.1",
        ips=['192.168.2.27/24','10.10.51.2/24','10.10.87.1/24','10.10.88.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)
    

    router53 = self.addHost('router53', loopback="127.0.0.1",
        ips=['192.168.2.28/24','10.10.52.2/24','10.10.89.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router54 = self.addHost('router54', loopback="127.0.0.1",
        ips=['192.168.2.29/24','10.10.53.2/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router55 = self.addHost('router55', loopback="127.0.0.1",
        ips=['192.168.2.30/24','10.10.54.2/24','10.10.90.1/24','10.10.91.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)
    

    router56 = self.addHost('router56', loopback="127.0.0.1",
        ips=['192.168.2.31/24','10.10.55.2/24','10.10.92.1/24','10.10.93.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router57 = self.addHost('router57', loopback="127.0.0.1",
              ips=['192.168.2.32/24','10.10.56.2/24','10.10.94.1/24'],
              controller_ip="192.168.2.10",
              cls=RAUSwitch)

    router58 = self.addHost('router58', loopback="127.0.0.1",
          ips=['192.168.2.33/24','10.10.57.2/24','10.10.95.1/24','10.10.96.1/24'],
          controller_ip="192.168.2.10",
          cls=RAUSwitch)
    

    router59 = self.addHost('router59', loopback="127.0.0.1",
              ips=['192.168.2.34/24','10.10.58.2/24'],
              controller_ip="192.168.2.10",
              cls=RAUSwitch)
    

    router60 = self.addHost('router60', loopback="127.0.0.1",
              ips=['192.168.2.35/24','10.10.59.2/24','10.10.97.1/24','10.10.98.1/24'],
              controller_ip="192.168.2.10",
              cls=RAUSwitch)

    router61 = self.addHost('router61', loopback="127.0.0.1",
        ips=['192.168.2.36/24','10.10.60.2/24','10.10.99.1/24','10.10.100.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router62 = self.addHost('router62', loopback="127.0.0.1",
        ips=['192.168.2.37/24','10.10.61.2/24','10.10.101.1/24','10.10.102.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)
    

    router63 = self.addHost('router63', loopback="127.0.0.1",
        ips=['192.168.2.38/24','10.10.62.2/24','10.10.103.1/24','10.10.104.1/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)
    

    router64 = self.addHost('router64', loopback="127.0.0.1",
        ips=['192.168.2.39/24','10.10.63.2/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router65 = self.addHost('router65', loopback="127.0.0.1",
        ips=['192.168.2.40/24','10.10.64.2/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router66 = self.addHost('router66', loopback="127.0.0.1",
        ips=['192.168.2.41/24','10.10.65.2/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)
    

    router67 = self.addHost('router67', loopback="127.0.0.1",
        ips=['192.168.2.42/24','10.10.66.2/24'],
        controller_ip="192.168.2.10",
        cls=RAUSwitch)

    router68 = self.addHost('router68', loopback="127.0.0.1",
              ips=['192.168.2.43/24','10.10.67.2/24'],
              controller_ip="192.168.2.10",
              cls=RAUSwitch)

    router69 = self.addHost('router69', loopback="127.0.0.1",
          ips=['192.168.2.44/24','10.10.68.2/24'],
          controller_ip="192.168.2.10",
          cls=RAUSwitch)
    

    router70 = self.addHost('router70', loopback="127.0.0.1",
              ips=['192.168.2.45/24','10.10.69.2/24'],
              controller_ip="192.168.2.10",
              cls=RAUSwitch)
    

    router71 = self.addHost('router71', loopback="127.0.0.1",
              ips=['192.168.3.11/24','10.10.70.2/24'],
              controller_ip="192.168.3.10",
              cls=RAUSwitch)

    router72 = self.addHost('router72', loopback="127.0.0.1",
        ips=['192.168.3.12/24','10.10.71.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router73 = self.addHost('router73', loopback="127.0.0.1",
        ips=['192.168.3.13/24','10.10.72.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)
    

    router74 = self.addHost('router74', loopback="127.0.0.1",
        ips=['192.168.3.14/24','10.10.73.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)
    

    router75 = self.addHost('router75', loopback="127.0.0.1",
        ips=['192.168.3.15/24','10.10.74.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router76 = self.addHost('router76', loopback="127.0.0.1",
        ips=['192.168.3.16/24','10.10.75.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router77 = self.addHost('router77', loopback="127.0.0.1",
        ips=['192.168.3.17/24','10.10.76.2/24','10.0.0.2/24'],
        controller_ip="192.168.3.10",
        border=1, ce_ip_address='10.0.0.1', ce_mac_address='00:00:00:00:00:01',
        cls=RAUSwitch)
    

    router78 = self.addHost('router78', loopback="127.0.0.1",
        ips=['192.168.3.18/24','10.10.77.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router79 = self.addHost('router79', loopback="127.0.0.1",
              ips=['192.168.3.19/24','10.10.78.2/24'],
              controller_ip="192.168.3.10",
              cls=RAUSwitch)

    router80 = self.addHost('router80', loopback="127.0.0.1",
          ips=['192.168.3.20/24','10.10.79.2/24'],
          controller_ip="192.168.3.10",
          cls=RAUSwitch)
    

    router81 = self.addHost('router81', loopback="127.0.0.1",
              ips=['192.168.3.21/24','10.10.80.2/24'],
              controller_ip="192.168.3.10",
              cls=RAUSwitch)
    

    router82 = self.addHost('router82', loopback="127.0.0.1",
              ips=['192.168.3.22/24','10.10.81.2/24'],
              controller_ip="192.168.3.10",
              cls=RAUSwitch)

    router83 = self.addHost('router83', loopback="127.0.0.1",
        ips=['192.168.3.23/24','10.10.82.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router84 = self.addHost('router84', loopback="127.0.0.1",
        ips=['192.168.3.24/24','10.10.83.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)
    

    router85 = self.addHost('router85', loopback="127.0.0.1",
        ips=['192.168.3.25/24','10.10.84.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)
    

    router86 = self.addHost('router86', loopback="127.0.0.1",
        ips=['192.168.3.26/24','10.10.85.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router87 = self.addHost('router87', loopback="127.0.0.1",
        ips=['192.168.3.27/24','10.10.86.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router88 = self.addHost('router88', loopback="127.0.0.1",
        ips=['192.168.3.28/24','10.10.87.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)
    

    router89 = self.addHost('router89', loopback="127.0.0.1",
        ips=['192.168.3.29/24','10.10.88.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router90 = self.addHost('router90', loopback="127.0.0.1",
        ips=['192.168.3.30/24','10.10.89.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router91 = self.addHost('router91', loopback="127.0.0.1",
        ips=['192.168.3.31/24','10.10.90.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router92 = self.addHost('router92', loopback="127.0.0.1",
        ips=['192.168.3.32/24','10.10.91.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router93 = self.addHost('router93', loopback="127.0.0.1",
        ips=['192.168.3.33/24','10.10.92.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router94 = self.addHost('router94', loopback="127.0.0.1",
        ips=['192.168.3.34/24','10.10.93.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router95 = self.addHost('router95', loopback="127.0.0.1",
        ips=['192.168.3.35/24','10.10.94.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router96 = self.addHost('router96', loopback="127.0.0.1",
        ips=['192.168.3.36/24','10.10.95.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router97 = self.addHost('router97', loopback="127.0.0.1",
        ips=['192.168.3.37/24','10.10.96.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router98 = self.addHost('router98', loopback="127.0.0.1",
        ips=['192.168.3.38/24','10.10.97.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router99 = self.addHost('router99', loopback="127.0.0.1",
        ips=['192.168.3.39/24','10.10.98.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router100 = self.addHost('router100', loopback="127.0.0.1",
        ips=['192.168.3.40/24','10.10.99.2/24','10.1.0.2/24'],
        controller_ip="192.168.3.10",
        border=1, ce_ip_address='10.1.0.1', ce_mac_address='00:00:00:00:00:02',
        cls=RAUSwitch)

    router101 = self.addHost('router101', loopback="127.0.0.1",
        ips=['192.168.3.41/24','10.10.100.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router102 = self.addHost('router102', loopback="127.0.0.1",
        ips=['192.168.3.42/24','10.10.101.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router103 = self.addHost('router103', loopback="127.0.0.1",
        ips=['192.168.3.43/24','10.10.102.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router104 = self.addHost('router104', loopback="127.0.0.1",
        ips=['192.168.3.44/24','10.10.103.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)

    router105 = self.addHost('router105', loopback="127.0.0.1",
        ips=['192.168.3.45/24','10.10.104.2/24'],
        controller_ip="192.168.3.10",
        cls=RAUSwitch)
    ...
    root = self.addHost('controller', cls=RAUController,
      ips=['192.168.1.10/24','192.168.2.10/24','192.168.3.10/24'])
