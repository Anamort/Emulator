...
class CustomTopology( Topo ):
  def __init__( self ):
    ...
    router1 = self.addHost('router1', ips=['192.168.1.11/24','10.10.1.1/24','10.0.0.2/24'],
			  controller_ip="192.168.1.10",
              border=1, ce_ip_address='10.0.0.1', ce_mac_address='00:00:00:00:00:01',
			  cls=RAUSwitch)

    router2 = self.addHost('router2', ips=['192.168.1.12/24','10.10.4.1/24','10.10.5.1/24'],
	      controller_ip="192.168.1.10",
	      cls=RAUSwitch)
    

    router3 = self.addHost('router3', ips=['192.168.1.13/24','10.10.1.2/24','10.10.3.1/24','10.10.2.1/24'],
			  controller_ip="192.168.1.10",
			  cls=RAUSwitch)
    

    router4 = self.addHost('router4', ips=['192.168.1.14/24','10.10.3.2/24','10.10.6.1/24'],
			  controller_ip="192.168.1.10",
			  cls=RAUSwitch)

    router5 = self.addHost('router5', ips=['192.168.1.15/24','10.10.4.2/24','10.10.7.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router6 = self.addHost('router6', ips=['192.168.1.16/24','10.10.7.2/24','10.10.8.1/24','10.10.9.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router7 = self.addHost('router7', ips=['192.168.1.17/24','10.10.8.2/24','10.10.10.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router8 = self.addHost('router8', ips=['192.168.1.18/24','10.10.10.2/24','10.10.11.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router9 = self.addHost('router9', ips=['192.168.1.19/24','10.10.6.2/24','10.10.11.2/24','10.10.12.1/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)

    router10 = self.addHost('router10', ips=['192.168.1.20/24','10.10.5.2/24','10.10.9.2/24'],
        controller_ip="192.168.1.10",
        cls=RAUSwitch)
    

    router11 = self.addHost('router11', ips=['192.168.1.21/24','10.10.2.2/24','10.10.12.2/24','10.1.0.2/24'],
        controller_ip="192.168.1.10",
    ...
    self.addLink(router11, routerLan2, 3, 0)
